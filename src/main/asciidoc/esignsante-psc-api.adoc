...
== Note importante sur les headers
Pour une demande de signature et uniquement pour une demande de signature que le webservice fonctionne ou non derrière Gravitee, les headers X-Userinfo et X-Introspectition-Response mentionnés ci-dessous ne doivent pas être renseigné par l'utilisateur. Par contre,  le Header 'Authorization', valorisé avec un token ProSante Connect valide est bien indispensable.
...
=== Note omportante sur les headers
Pour une demande de signature, que le webservice fonctionne ou non derrière Gravitee, les headers X-Userinfo et X-Introspectition-Response mentionnés ci-dessous ne doivent pas être renseigné par l'utilisateur.
Par contre,  le Header 'Authorization' avec un token ProSante Connect valide est bien indispensable.
