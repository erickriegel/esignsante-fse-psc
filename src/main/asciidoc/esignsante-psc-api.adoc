...
.request
include::{snippets}/signXADES/HeaderKO/http-request.adoc[]

payload:
include::{snippets}/signXADES/HeaderKO/request-body.adoc[]


.response
include::{snippets}/signXADES/HeaderKO/http-response.adoc[]


=== Cas Stream In KO
.request
include::{snippets}/signXADES/StreamKo/http-request.adoc[]


.response
include::{snippets}/signXADES/StreamKo/http-response.adoc[]
