...
.request
http:
include::{snippets}/FSE/OK/http-request.adoc[]

Requête avec curl:
include::{snippets}/FSE/OK/curl-request.adoc[]

.response
include::{snippets}/FSE/OK/http-response.adoc[]

Payload:
include::{snippets}/FSE/OK/response-body.adoc[]

=== cas non passant 401
Le token fourni n'est plus valide

.request
http:
include::{snippets}/FSE/TokenKo/http-request.adoc[]

Requête avec curl:
include::{snippets}/FSE/TokenKo/curl-request.adoc[]

.response
include::{snippets}/FSE/TokenKo/http-response.adoc[]
...
http:
include::{snippets}/FSE/esginWS_OFF/http-request.adoc[]

Requête avec curl:
include::{snippets}/FSE/esginWS_OFF/curl-request.adoc[]

.response
include::{snippets}/FSE/esginWS_OFF/http-response.adoc[]
