...
public class DefaultApiIntegrationTest {
	...
	public void rootGetTest() throws Exception {
		...
		final String body= "[{\"path\":\"/ca\",\"description\":\"Opération qui permet au client de prendre connaissance des Autorités de Certification de confiance utilisées par la plateforme.\",\"payload\":\"\",\"requiredHeaders\":\"accept:application/json\"},"
				+ "{\"path\":\"/checksignature/xades\",\"description\":\"Opération qui permet de vérifier un document signé au format PADES Baseline-B.\",\"payload\":\"file:sigendPadesDoc\",\"requiredHeaders\":\"accept:application/json\"},"
				+ "{\"path\":\"/checksignature/xades\",\"description\":\"Opération qui permet de vérifier un document signé au format XADES Baseline-B.\",\"payload\":\"file:sigendXadesDoc\",\"requiredHeaders\":\"accept:application/json\"},"
				+ "{\"path\":\"/asksignature/fse\",\"description\":\"Opération qui permet au client de demander la signature d'un hash d'une feuille de soin.\",\"payload\":\"[\\\"hashFSE: hashToSign\\\", \\\"idFacturationPS: 123456\\\", \\\"typeFlux: T\\\"]\",\"requiredHeaders\":\"[\\\"accept:application/json\\\", \\\"accept:application/octet-stream\\\", \\\"Authorization: PSCVAlidAccessToken\\\"]\"},"
				+ "{\"path\":\"/asksignature/xades\",\"description\":\"Opération qui permet au client de demander de signer un document au format XADES Baseline-B.\",\"payload\":\"[\\\"file: docXMLToSign\\\"]\",\"requiredHeaders\":\"[\\\"accept:application/json\\\", \\\"accept:application/xml\\\", \\\"Authorization: PSCVAlidAccessToken\\\"]\"},"				
				+ "{\"path\":\"/asksignature/pades\",\"description\":\"Opération qui permet au client de demander de signer un document au format PADES Baseline-B.\",\"payload\":\"[\\\"file: docXMLToSign\\\"]\",\"requiredHeaders\":\"[\\\"accept:application/json\\\", \\\"accept:application/pdf\\\", \\\"Authorization: PSCVAlidAccessToken\\\"]\"},"
				+ "{\"path\":\"/\",\"description\":\"Liste des opérations disponibles\",\"payload\":\"\",\"requiredHeaders\":\"accept:application/json\"}]";
